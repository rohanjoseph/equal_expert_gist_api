...
* When you have completed the assignment, you need to  push your code to this repository and [mark the assignment as completed by clicking here](https://app.snapcode.review/submission_links/c6ef8f33-5e41-4ade-b8e7-de6195eb96aa).
...
### Usage
`/` Landing page
`/getdata/<username>/` - Fetch user's gists

### Tests
python manage.py test django_gist

Includes tests for valid/invalid users and edge cases using `octocat` as test data.
